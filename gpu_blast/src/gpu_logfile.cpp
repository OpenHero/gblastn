...
long long getSystemTime() {
	...
	return (1000000.0 * (start_time.tv_sec) + start_time.tv_usec);
...
__int64 CLogFile::NewStart(bool is_log)
{ 
	if (is_log)
	{
#ifdef WIN32
...
__int64 CLogFile::NewEnd(bool is_log)
{
	if (is_log)
	{
#ifdef WIN32
...
double CLogFile::printElaplsedTime(string id, __int64 in_c1, __int64 in_c2)
{
...
double CLogFile::elaplsedTime(__int64 in_c1, __int64 in_c2)
{
#ifdef WIN32					  
...
void CLogFile::addTotalTime(string id, __int64 in_c1, __int64 in_c2, bool is_print)
{
#if LOG_TIME
